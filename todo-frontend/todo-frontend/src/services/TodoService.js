...
axios.interceptors.request.use(function (config) {
    ...
    const token =  config.headers['Authorization'] = getToken();    // getting then token and adding it to headers to config object
...
export const getAllTodos = () => axios.get(BASE_REST_API_URL);  // Simplified
